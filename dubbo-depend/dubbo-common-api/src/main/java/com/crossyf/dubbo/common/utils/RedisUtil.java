...
public class RedisUtil {
     ...
     * @return
     */
    public List<Object> lGet(Integer indexdb, String key,long start, long end){
        try {
            redisTemplate.indexdb.set(indexdb);
     ...
     * @return
     */
    public long lGetListSize(Integer indexdb, String key){
        try {
            redisTemplate.indexdb.set(indexdb);
     ...
     * @return
     */
    public boolean lSet(Integer indexdb, String key, List<Object> value) {
        try {
            redisTemplate.indexdb.set(indexdb);
